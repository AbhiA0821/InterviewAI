        ...
        <div className="relative max-w-3xl space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2.5 rounded-xl border border-indigo-500/40 bg-indigo-500/10 px-6 py-3.5 text-base font-semibold text-indigo-300 shadow-sm transition-all hover:bg-indigo-500/20"
            >
